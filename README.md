...
# __Parte IV - APLICACIÓN MVC JUEGO__
 * ¿Qué pasa si abro el sitio de juegos en dos navegadores difententes?
    * Se comparte el estado actual del juego independientemente si se abre en un nuevo navegador.

* Si quisiera qué a cada jugador le aparecieran independientemente sus respectivos saldos. ¿Qué habría que hacer?
    * Ambos jugadores deberían estar corriendo el juego de forma independiemte.
